...
<div class="wrapper" id="vue-app" >
    ...
    <div class="content-wrapper" style="margin-left: 0px !important;" >
        ...
        <section class="content-header">
            <h1>Внутренние номера<small>(extensions)</small></h1>
            <ol class="breadcrumb">
            ...
            <div style="width:98%; padding:5px; margin:4px 0px 0px 10px" >
                ...
                <div  class="box box-info" style="margin-top:10px;" >
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Создать новый номер</h3>
                        <!-- tools box -->
                    ...
                    <div class="box-body">
                        <form action="http://192.168.3.15/admin/config.php" method="POST" >

                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label>Название</label>
                                    <input type="text" class="form-control" id="group" name="username" placeholder="Название" required="">
                                </div>

                                <div class="col-xs-6">
                                    <label>Номер</label>
                                    <input type="text" class="form-control" id="group" name="extension" placeholder="Номер" required="">
                                </div>
                            </div>
                    ...
                    <div class="box-footer clearfix">
                        ...
                        Сохранить <i class="fa fa-arrow-circle-right"></i></button>
                    </div>
                    -->
