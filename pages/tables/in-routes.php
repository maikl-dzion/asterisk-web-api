            ...
            <div style="width:98%; padding:5px; margin:4px 0px 0px 10px" >
                ...
                <div v-if="formStatus" class="box box-info" style="margin-top:10px;" >
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Создать новую линию</h3>
                        <!-- tools box -->
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input type="text" class="form-control" id="group" name="group" placeholder="Название" required="">
                                </div>

                                <div class="col-xs-6">
                                    <label>Номер</label>
                                    <input type="text" class="form-control" id="group" name="group" placeholder="Номер" required="">
                                </div>
                            </div>

                            <!--
                           <div class="form-group">
                               <input v-model="item.trunk" type="text" class="form-control" name="subject" placeholder="Внешний номер">
                           </div>


                           <div class="form-group">
                               <input v-model="item.phone" type="text" class="form-control" name="subject" placeholder="Внутренний номер">
                           </div>
                           -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option>734-23-56</option>
                                        <option>701-25-59</option>
                                        <option>789-34-90</option>
                            ...
                            <!--
                               <div><textarea class="textarea" placeholder="Комментарии" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea></div>
                            -->
                        </form>
                    </div>
