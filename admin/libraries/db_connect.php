...
//$ampConf['AMPDBUSER']	= 'asteriskuser';
//$ampConf['AMPDBPASS']   = '123456Aa';
//$ampConf['AMPDBHOST']	= 'localhost';
//$ampConf['AMPDBNAME']	= 'asterisk';
//$ampConf['AMPDBENGINE'] = 'mysql';
//$ampConf['datasource']	= ''; //for sqlite3
//
//$dsn="{$ampConf['AMPDBENGINE']}://{$ampConf['AMPDBUSER']}:{$ampConf['AMPDBPASS']}@{$ampConf['AMPDBHOST']}/{$ampConf['AMPDBNAME']}";
//$myDB= DB::connect($dsn, true);
//
//lg($myDB);
