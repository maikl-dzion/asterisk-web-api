...
class freepbx_conf {
  ...
  // 'AMPWEBROOT'     => array(CONF_TYPE_DIR, '/var/www/html/admin-lte'),
  ...
  function __construct() {
    ...
    $webRootDir = FREEPBX_WEB_ROOT_DIR;
    $this->legacy_conf_defaults['AMPWEBROOT'][1] = $webRootDir;

    // lg($this->legacy_conf_defaults['AMPWEBROOT'][1]);
