...
if( !empty($_GET['rest_full_api']) &&
	!empty($_GET['action']) &&
	$_GET['action'] == '_getAsteriskConf' ) {
    getRestApiResponse(array('ampConf'     => $amp_conf,
		                     'freePbxConf' => $freepbx_conf,
		                     'asteriskConf' => $asterisk_conf));
}
