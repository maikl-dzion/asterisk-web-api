...
// lg($dirname . '/helpers/form_helper.php');
...
function fpbx_framework_autoloader($class)
{
    ...
    // $FREEPBX_ADMIN_DIR = '/var/www/html/' .$currentDir. '/admin/';
    $FREEPBX_ADMIN_DIR = $dirname;

    foreach ($class as $this_class) {
        if (class_exists($this_class)) { continue; }

        switch ($this_class) {
            case 'ampuser':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/ampuser.class.php');
                break;
            case 'CI_Email':
                ...
                require_once($FREEPBX_ADMIN_DIR . '/helpers/Email.php');
                break;
            case 'CI_Table':
                ...
                require_once($FREEPBX_ADMIN_DIR . '/helpers/Table.php');
                break;
            case 'CssMin':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/cssmin.class.php');
                break;
            case 'component':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/components.class.php');
                break;
            case 'featurecode':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/featurecodes.class.php');
                break;
            case 'cronmanager':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/cronmanager.class.php');
                break;
            case 'moduleHook':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/moduleHook.class.php');
                break;
            case 'modulelist':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/modulelist.class.php');
                break;
            case 'modgettext':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/modgettext.class.php');
                break;
            case 'notifications':
                // lg($amp_conf['AMPWEBROOT']);
                require_once($FREEPBX_ADMIN_DIR . '/libraries/notifications.class.php');
                break;
            case 'xml2Array':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/xml2Array.class.php');
                break;
            case 'fwmsg':
                require_once($FREEPBX_ADMIN_DIR . '/libraries/fwmsg.class.php');
                break;
            default:
