...
if (!$quietmode) {
        ...
        <form name="db_online_form" action="#" method="post">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input id="update_email" type="email" required size="40" name="update_email"
                               saved-value="<?php echo $ue ?>" value="<?php echo $ue ?>"/>
                    </td>
                </tr>
            </table>
        </form>
    ...
    <div id="shield_link_div">
        <a href="#" id="show_auto_update" title="<?php echo $utitle ?>"><span id="shield_link"
                                                                              class="<?php echo $shield_class ?>"></span></a>
    </div>
    <?php
        ...
        <div class="module_security_description" id="security-<?php echo $id ?>" style="display: none;">
            <table>
                ...
                <tr>
                    ...
                    <td><?php echo $security_array[$id]['type'] ?></td>
                </tr>
                <tr>
                    <td><?php echo _('Severity') ?></td>
                    <td><?php echo $security_array[$id]['severity'] ?></td>
                </tr>
                <tr>
                    <td><?php echo _('Description') ?></td>
                    <td><?php echo $security_array[$id]['description'] ?></td>
                </tr>
                <tr>
                    <td><?php echo _('Date Reported') ?></td>
                    <td><?php echo $security_array[$id]['reported'] ?></td>
                </tr>
                <tr>
                    <td><?php echo _('Date Fixed') ?></td>
                    <td><?php echo $security_array[$id]['fixed'] ?></td>
                </tr>
                <?php
            ...
            <tr>
                ...
                <td>
                    <table>
                        <tr class="repo_boxes">
                            <td>
                                <input id="standard_repo" type="checkbox" name="active_repos[standard]" value="1"
                                       tabindex="<?php echo ++$tabindex; ?>"<?php echo isset($active_repos['standard']) ? "checked" : "" ?>/>
                                <label for="standard_repo"><?php echo _("Basic") ?></label>
                            </td>
                            <td>
                                <input id="extended_repo" type="checkbox" name="active_repos[extended]" value="1"
                                       tabindex="<?php echo ++$tabindex; ?>"<?php echo isset($active_repos['extended']) ? "checked" : "" ?>/>
                                <label for="extended_repo"><?php echo _("Extended") ?></label>
                            </td>
                            <td>
                                <input id="unsupported_repo" type="checkbox" name="active_repos[unsupported]" value="1"
                                       tabindex="<?php echo ++$tabindex; ?>"<?php echo isset($active_repos['unsupported']) ? "checked" : "" ?>/>
                                <label for="unsupported_repo"><?php echo _("Unsupported") ?></label>
                            </td>
                            <td>
                                <input id="commercial_repo" type="checkbox" name="active_repos[commercial]" value="1"
                                       tabindex="<?php echo ++$tabindex; ?>"<?php echo isset($active_repos['commercial']) ? "checked" : "" ?>/>
